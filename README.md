# ./ios.sh -x --disable-armv7 --disable-x86-64 --disable-arm64e --disable-x86-64-mac-catalyst --disable-arm64-mac-catalyst
# Support Apple SSL Transport in development branch
